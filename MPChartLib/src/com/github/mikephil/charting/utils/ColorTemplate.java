...
public class ColorTemplate {
    ...
    public static final int[] MATERIAL_COLORS = {
            rgb("#2E5A8E"), rgb("#A96923"), rgb("#90302C"), rgb("#708B36"), rgb("#5D467B"),
            rgb("#2F8299"), rgb("#738DA2"), rgb("#025E5E"), rgb("#5C7A02"), rgb("#A37C0C"),
            rgb("#A34A30"), rgb("#6A090C"), rgb("#6B5A7E"), rgb("#884706"), rgb("#A5825B"),
            rgb("#305B8F"), rgb("#A86822"), rgb("#B93935"), rgb("#8EB345"), rgb("#FFC6F7"),
            rgb("#FE00F7"), rgb("#C500BE"), rgb("#8E009E"), rgb("#9B0005"), rgb("#C60005"),
            rgb("#FF0005"), rgb("#FF9035"), rgb("#FF0905"), rgb("#FFFA05"), rgb("#2FFF00")
    };
